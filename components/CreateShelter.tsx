...
const createShelterFormSchema = z.object({
    ...
    ShelterCapacity: z.number({ required_error: "Kapasitas shelter tidak boleh kosong" }).int().positive({message: "Harus lebih dari 0"}).nonnegative("Kapasitas shelter harus merupakan bilangan bulat positif"),
